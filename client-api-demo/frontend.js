$(function () {
    ...
    chatwoot.inboxIdentifier = "oqaHvF8Pn6jFig9mhxE4YiD5";
    chatwoot.chatwootAPIUrl = "http://192.168.58.7:3000/public/api/v1/"
    ...
    // open connection
    var connection = new WebSocket('ws://192.168.58.7:3000/cable');
